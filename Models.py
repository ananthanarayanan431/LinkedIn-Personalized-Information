...
class Interest(BaseModel):
    Interest:List[str]=Field(description="Topic of Interest of that particular person!")

    def ans(self)->Dict[str,Any]:
        return {'interest':self.Interest}
    
class IceBreaker(BaseModel):
    IceBreaker:List[str]=Field(description="Icebreakers for particular person based on the topic of Interest or Background")
